...
get "/database" do
	...
	otherMes = []
#    mongHost = ENV["mongo_service_host"] || 'localhost'
#    mongPort = ENV["mongo_service_port"] || '27077'
    mongHost = ENV["mongo_service_host"] || "mongo_service_host"
    mongPort = ENV["mongo_service_port"] || "mongo_service_port"
    begin
      mongClient = Mongo::Client.new([mongHost + ":" + mongPort], :database => "currConvy", :server_selection_timeout => 2)
